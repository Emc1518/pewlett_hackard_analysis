...
--7.3.4 skill drill create new table & export as csv
...
--7.36 skill drill#1 Create a query that will return only the information relevant to the Sales team. The requested list includes:
-- Employee numbers
-- Employee first name
-- Employee last name
